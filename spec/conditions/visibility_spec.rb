  ...
  context '.match' do
    ...
    context 'when parsing public methods' do
      ...
      it 'using an object as an origin' do
        ...
        expect(visibility_filter.match(test_instance).include?(method_xyz))
        expect(visibility_filter.match(test_instance).include?(method_xyy))
        expect(visibility_filter.match(test_instance).include?(test_instance.method(:yyy)))

        expect(visibility_filter.match(test_instance)).not_to include(method_xxx, test_instance.method(:yyyy))
    ...
    context 'when parsing private methods' do
      ...
      it 'using an object as an origin' do
        ...
        expect(visibility_filter.match(test_instance).include?(method_xxx))
        expect(visibility_filter.match(test_instance).include?(test_instance.method(:yyyy)))

        expect(visibility_filter.match(test_class)).not_to include(method_xyz, method_xyy)
      end
